...
export default function WorkWear() {
  ...
  const subcategories = [
    ...
    { id: 'formal-top-shirts', name: 'Formal Top Shirts' },
    { id: 'formal-trouser', name: 'Formal Trousers' },
    { id: 'smart-casuals', name: 'Smart Casuals' },
    { id: 'semi-formals', name: 'Semi Formals' },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] sm:h-[70vh] flex items-center justify-center overflow-hidden py-8 sm:py-0">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-100 via-gray-50 to-zinc-100 dark:from-gray-900 dark:via-slate-900/20 dark:to-gray-900"></div>
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-6xl mx-auto">
          <div className="inline-block mb-3 sm:mb-4 md:mb-6 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-slate-200 dark:border-slate-800">
            <span className="text-[10px] sm:text-xs md:text-sm font-light tracking-wider text-slate-600 dark:text-slate-400">PROFESSIONAL ATTIRE</span>
          </div>
          ...
          <p className="text-xs sm:text-base md:text-lg lg:text-xl font-light text-gray-700 dark:text-gray-300 mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed px-2 sm:px-4">
            Professional attire for the modern workplace
          </p>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-16 sm:py-20">
            <div className="text-center">
              <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-b-2 border-slate-600 mx-auto mb-4"></div>
          ...
          <div className="text-center py-16 sm:py-20 bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-900/10 dark:to-gray-900/10 rounded-2xl border border-slate-100 dark:border-slate-900/30">
            <Briefcase className="w-12 h-12 sm:w-16 sm:h-16 text-slate-300 dark:text-slate-700 mx-auto mb-4" />
            <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm sm:text-base px-4">No products found in this category</p>
            <Link
              to="/shop"
              className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 font-medium text-sm sm:text-base"
            >
              Browse all products
