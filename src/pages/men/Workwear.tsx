...
export default function MenWorkwear() {
  const [products, setProducts] = useState<Product[]>([]);
  const [loading, setLoading] = useState(true);

  const heroImage = 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=1920';
        ...
        {loading ? (
          <div className="flex justify-center items-center py-16 sm:py-20">
            <div className="text-center">
              <div className="rounded-full h-12 w-12 sm:h-16 sm:w-16 border-4 border-slate-200 border-t-slate-600 animate-[spin_1s_linear_infinite_reverse] mx-auto mb-4"></div>
