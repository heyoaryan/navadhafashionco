...
export default function WesternWear() {
  ...
  const subcategories = [
    ...
    { id: 'top-shirts', name: 'Top Shirts' },
    { id: 'jackets', name: 'Jackets' },
    { id: 'shrug', name: 'Shrugs' },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] sm:h-[70vh] flex items-center justify-center overflow-hidden py-8 sm:py-0">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-indigo-50 to-purple-100 dark:from-gray-900 dark:via-blue-900/20 dark:to-gray-900"></div>
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-6xl mx-auto">
          <div className="inline-block mb-3 sm:mb-4 md:mb-6 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-blue-200 dark:border-blue-800">
            <span className="text-[10px] sm:text-xs md:text-sm font-light tracking-wider text-blue-600 dark:text-blue-400">TRENDY COLLECTION</span>
          </div>
          ...
          <p className="text-xs sm:text-base md:text-lg lg:text-xl font-light text-gray-700 dark:text-gray-300 mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed px-2 sm:px-4">
            Explore our collection of trendy western wear for every occasion
          </p>
