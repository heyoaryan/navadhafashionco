...
export default function WesternWear() {
  ...
  const heroImages = {
    women: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1920&q=80',
    men: 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=1920',
    all: [
      ...
      <section className="relative min-h-[60vh] sm:h-[70vh] flex items-center justify-center overflow-hidden py-8 sm:py-0">
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-6xl mx-auto">
          <div className="inline-block mb-3 sm:mb-4 md:mb-6 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full border border-white/30">
            <span className="text-[10px] sm:text-xs md:text-sm font-medium tracking-widest text-gray-700 dark:text-gray-300 uppercase">TRENDY COLLECTION</span>
          </div>
