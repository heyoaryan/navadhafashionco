        ...
        {loading ? (
          <div className="flex justify-center items-center py-16 sm:py-20">
            <div className="text-center">
              <div className="rounded-full h-12 w-12 sm:h-16 sm:w-16 border-4 border-amber-200 border-t-amber-500 animate-[spin_1s_linear_infinite_reverse] mx-auto mb-4"></div>
