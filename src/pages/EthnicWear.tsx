  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] sm:h-[70vh] flex items-center justify-center overflow-hidden py-8 sm:py-0">
        <div className="absolute inset-0 bg-gradient-to-br from-pink-100 via-rose-50 to-red-100 dark:from-gray-900 dark:via-pink-900/20 dark:to-gray-900"></div>
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-6xl mx-auto">
          <div className="inline-block mb-3 sm:mb-4 md:mb-6 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-pink-200 dark:border-pink-800">
            <span className="text-[10px] sm:text-xs md:text-sm font-light tracking-wider text-pink-600 dark:text-pink-400">TRADITIONAL ELEGANCE</span>
          </div>
