...
export default function OccasionalWear() {
        ...
        {loading ? (
          <div className="flex justify-center items-center py-16 sm:py-20">
            <div className="text-center">
              <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-b-2 border-violet-500 mx-auto mb-4"></div>
          ...
          <div className="text-center py-16 sm:py-20 bg-gradient-to-br from-violet-50 to-fuchsia-50 dark:from-violet-900/10 dark:to-fuchsia-900/10 rounded-2xl border border-violet-100 dark:border-violet-900/30">
            <PartyPopper className="w-12 h-12 sm:w-16 sm:h-16 text-violet-300 dark:text-violet-700 mx-auto mb-4" />
            <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm sm:text-base px-4">No products found in this category</p>
            <Link
              to="/shop"
              className="inline-flex items-center gap-2 text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 font-medium text-sm sm:text-base"
            >
              Browse all products
