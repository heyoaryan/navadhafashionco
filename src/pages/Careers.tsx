...
import { MapPin, Wifi, Briefcase, ArrowRight, Users, Target, Rocket, Home, FileText, Video, CheckCircle, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-8 sm:mb-12 px-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Ready to Join?</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16 lg:mb-20">
          ...
          >
            ...
            <div className="p-5 sm:p-6 lg:p-8">
              <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3">Store Positions</h3>
              ...
              <div className="flex items-center gap-2 text-sm sm:text-base text-gray-900 dark:text-white font-semibold group-hover:gap-4 transition-all">
          ...
          >
            ...
            <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
              ...
              <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-lg flex items-center justify-center">
                  <Wifi className="w-5 h-5 sm:w-6 sm:h-6 text-gray-900" />
                </div>
              </div>
            </div>
            ...
            {/* Content */}
            <div className="p-5 sm:p-6 lg:p-8">
              <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3">Remote Positions</h3>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-4 sm:mb-6">
