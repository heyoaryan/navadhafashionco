          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="text-center">
              ...
              <p className="text-base sm:text-lg text-gray-300 max-w-2xl mx-auto px-4">
                Flexible remote opportunities for digital roles and creative positions across India
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {filteredJobs.map((job) => (
            ...
            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        <span className="whitespace-nowrap">Work From Home</span>
                      </span>
                    </div>
                  </div>
                  <ChevronDown
              ...
              {expandedJob === job.id && (
                <div className="px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-200 dark:border-gray-700 pt-4 sm:pt-6">
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-4 sm:mb-6">{job.description}</p>
                  
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold mb-2 sm:mb-3">Responsibilities</h4>
                      <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                        {job.responsibilities.map((resp, index) => (
                          <li key={index} className="flex items-start gap-2">
                            <span className="text-gray-900 dark:text-white mt-0.5 sm:mt-1">•</span>
                            <span>{resp}</span>
                          </li>
                        ))}
                      </ul>
                    ...
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold mb-2 sm:mb-3">Requirements</h4>
                      <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-800 dark:hover:bg-gray-100 transition-all"
                  >
